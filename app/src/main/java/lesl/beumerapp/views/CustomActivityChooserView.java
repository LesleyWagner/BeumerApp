 ...
 * @hide
 */
public class CustomActivityChooserView extends ViewGroup implements
     ...
     */
    public CustomActivityChooserView(Context context) {
        this(context, null);
    }
    /**
     * Create a new instance.
     ...
     */
    public CustomActivityChooserView(Context context, AttributeSet attrs) {
     ...
     */
    public CustomActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private ListPopupWindow getListPopupWindow() {
        if (mListPopupWindow == null) {
            ...
            mListPopupWindow.setAnchorView(CustomActivityChooserView.this);
